        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="/php/getpost.php">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    <div class="container mt-3">
        ...
        <p>This example form demonstrates basic form field types and their associated feedback styles.</p>
        ...
        <form action="/php/form.php" method="post">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="desc" name="description" cols="30" rows="10"></textarea>
